 Shader "Custom/SupershapeTest" {
     Properties {
		...
		[Space(20)][UV Scrolling)][Space(20)]
		...
		[Space(20)][X Modulation)][Space(20)]
		 ...
		 // of the sphere
		[Space(20)][Y Modulation)][Space(20)]
     ...
     SubShader {
        ...
        // #pragma surface surf Standard fullforwardshadows
 		#pragma surface surf Standard vertex:vert fullforwardshadows tessellate:tessFixed nolightmap
		...
		// float _OffsetVal;
		 ...
		 void surf(Input IN, inout SurfaceOutputStandard o) {
			...
			// o.Albedo = IN.vertColor.rgb;
			 o.Emission.rgb = _EmissionColor * (_Emission - factor * _Emission);
