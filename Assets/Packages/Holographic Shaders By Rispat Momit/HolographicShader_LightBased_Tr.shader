...
Shader "RM/Holographic/LB Transparent" {
    Properties {
      ...
      _Emission ("Emission", Range(0.0, 50)) = 2
...
Lighting Off
      ...
      #pragma surface surf WrapLambert addshadow vertex:vert alpha:fade
